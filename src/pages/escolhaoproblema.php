...
<head>
    ...
    <link rel="stylesheet" href="../styles/escolhaProblema.css">
    
    <title>Selecione o problema</title>
</head>
<body>
<?php
        session_start();
    ...
    <div id="container">
        <div class="content">
            ...
            <select class="modelo">
                <option value="exemplo1">Problema1</option>
                <option value="exemplo2">Problema2</option>
                <option value="exemplo3">Problema3</option>
                <option value="exemplo4">Problema4</option>
            </select>

            
                <input type="text" placeholder="Outro:"id="outroProblema">
            </form>
