...
<body>
    ...
    <section class="barraLateral">
        ...
        <form action="" method="post" class="formPesquisa">
    ...
    <section class="chatContainer">
        ...
        <div class="envio">
            <form action="../php/chat.php" method="POST" class="formMensagem" autocomplete="off">
                ...
                <input type="text" name="mensagem" id="mensagem" placeholder="Envie uma mensagem" required/>
    ...
    <script src="../js/loadConversations.js" ></script>
